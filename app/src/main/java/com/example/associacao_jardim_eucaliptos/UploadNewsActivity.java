...
public class UploadNewsActivity extends AppCompatActivity {
    ...
    Button saveButton;
    TextView uploadTopic, uploadDesc;
    String imageURL;
    Uri uri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uploadDesc = findViewById(R.id.uploadNewsDesc);
        uploadTopic = findViewById(R.id.uploadNewsTopic);
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK) {
                            ...
                            Toast.makeText(UploadNewsActivity.this, "No Image Selected", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
        );
